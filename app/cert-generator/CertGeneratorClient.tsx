...
export default function CertGeneratorClient({ lang = 'zh-TW' }: Props) {
    ...
    try {
      ...
      if (mode === 'self-signed') {
        ...
        const ca = await generateCaCertificate({
          commonName: caCommonName.trim() || 'Local Dev Root CA',
          organization: organization.trim() || undefined,
          countryCode: countryCode.trim() || undefined,
          validityDays,
          algorithm,
        ...
        setIdentities([
          toIdentity(t.caIdentityLabel, ca, caCommonName || 'root'),
  ...
  }, [mode, identityCommonName, caCommonName, organization, countryCode, sanInput, validityDays, algorithm, t]);
