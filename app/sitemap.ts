...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: Array<{
    ...
    { url: '/password/', lastModified: '2026-07-28', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/password/en/', lastModified: '2026-07-29', changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: '/ssl-converter/', lastModified: '2026-08-13', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/ssl-converter/en/', lastModified: '2026-08-13', changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: '/lucky-wheel/en/', lastModified: '2026-07-30', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/pdf-processor/', lastModified: '2026-07-28', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/pdf-processor/en/', lastModified: '2026-07-30', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/pdf-compressor/', lastModified: '2026-07-28', changeFrequency: 'monthly', priority: 0.8 },
    { url: '/pdf-compressor/en/', lastModified: '2026-07-30', changeFrequency: 'monthly', priority: 0.8 },
