...
export const TRANSLATIONS: Record<'zh-TW' | 'en', OgTranslation> = {
  ...
  en: {
    ...
    templateCountLabel: '4 Professional Templates',
    templates: {
    ...
    logoLoaded: 'Custom Logo Loaded (Click to replace)',
    ...
    bgLoaded: 'Feature & Background Image Loaded (Click to replace)',
